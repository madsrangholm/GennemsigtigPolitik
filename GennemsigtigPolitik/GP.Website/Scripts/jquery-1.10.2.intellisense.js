...
intellisense.annotate(jQuery, {
  'ajax': function() {
    ...
    ///   <param name="settings" type="PlainObject">A set of Value/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
    /// <signature>
    ///   <summary>Perform an asynchronous HTTP (Ajax) request.</summary>
    ///   <param name="settings" type="PlainObject">A set of Value/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with $.ajaxSetup().</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  ...
  'ajaxSetup': function() {
    ...
    ///   <param name="options" type="PlainObject">A set of Value/value pairs that configure the default Ajax request. All options are optional.</param>
    /// </signature>
  },
  ...
  'data': function() {
    ...
    ///   <param name="Value" type="String">Name of the data stored.</param>
    ///   <returns type="Object" />
    /// </signature>
    /// <signature>
    ///   <summary>Returns value at named data store for the element, as set by jQuery.data(element, name, value), or the full data store for the element.</summary>
  ...
  'map': function() {
    ...
    ///   <param name="callback( value, indexOrKey )" type="Function">The function to process each item against.  The first argument to the function is the value; the second argument is the index or Value of the array or object property. The function can return any value to add to the array. A returned array will be flattened into the resulting array. Within the function, this refers to the global (window) object.</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'merge': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'metaKey': function() {
    /// <summary>Indicates whether the META Value was pressed when the event fired.</summary>
    /// <returns type="Boolean" />
  },
  'namespace': function() {
  ...
  'which': function() {
    /// <summary>For Value or mouse events, this property indicates the specific Value or button that was pressed.</summary>
    /// <returns type="Number" />
  },
});
...
intellisense.annotate(jQuery.fn, {
  ...
  'data': function() {
    ...
    ///   <param name="Value" type="String">A string naming the piece of data to set.</param>
    ///   <param name="value" type="Object">The new data value; it can be any Javascript type including Array or Object.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Store arbitrary data associated with the matched elements.</summary>
    ///   <param name="obj" type="Object">An object of Value-value pairs of data to update.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'dblclick': function() {
